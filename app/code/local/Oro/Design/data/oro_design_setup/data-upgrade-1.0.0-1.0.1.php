...
<div class="accordion-box">
    <div class="top-content">
         <p>
             BH Cosmetics offers beautiful eye makeup, lipstick, face makeup and accessories. We use only the highest quality ingredients and guarantee you will enjoy our full line of beauty products for looks that last all day and night!
...
$installer->setConfigData('design/header/logo_alt', 'StockUpExpress.com');
...
$installer->setConfigData('design/head/default_title', 'StockUpExpress');
$installer->setConfigData('design/header/welcome', 'Skip the trip to the big box stores');
$installer->setConfigData('design/footer/copyright', '&copy; 2015 StockUpExpress.com. All Rights Reserved.');